            ...
            <div>
                <nav class="isolate inline-flex -space-x-px rounded-md text-sm" aria-label="Pagination">
                    ...
                    <Link
                        ...
                        class="relative inline-flex items-center rounded-l-md px-3 py-2"
                        :class="{
                        'z-10 text-primary-foreground bg-accent': meta.links[0].active,
                        'text-primary-foreground bg-primary hover:bg-accent': !meta.links[0].active
                        }"
                        preserve-scroll
                    />
                    ...
                    <Link
                        ...
                        :class="{
                        'z-10 text-primary-foreground bg-accent': link.active,
                        'text-primary-foreground bg-primary hover:bg-accent': !link.active
                        }"
                        preserve-scroll
                    />
                    ...
                    <Link
                        ...
                        class="relative inline-flex items-center rounded-r-md px-3 py-2"
                        :class="{
                        'z-10 text-primary-foreground bg-accent': meta.links[meta.links.length - 1].active,
                        'text-primary-foreground bg-primary hover:bg-accent': !meta.links[meta.links.length - 1].active
                        }"
                        preserve-scroll
                    />
                </nav>
